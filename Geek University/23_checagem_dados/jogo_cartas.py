...
def distribuir(baralho: BARALHO) -> Tuple[BARALHO, BARALHO, BARALHO, BARALHO]:
...
def jogar() -> None:
    ...
    cartas: BARALHO = criar_baralho(True)
    jogadores: List[str] = 'P1 P2 P3 P4'.split()
    maos: Dict[str, BARALHO] = {j: m for j, m in zip(jogadores, distribuir(cartas))}
